...
HAMILTONIAN_PATH=$HOME/HamData/BC_red_ducc_8-5-xacc        #"$HOME/HamData/bztz66ducc3.hamil"                  #"$HOME/HamData/B_red_ducc_8-5-xacc"
NUM_PARTICLES=16           #16 6
...
nvidia-smi --query-gpu=gpu_name,gpu_bus_id,memory.used,utilization.gpu \
    --format=csv >> printouts/gpu_utilization_${SLURM_JOBID}.log